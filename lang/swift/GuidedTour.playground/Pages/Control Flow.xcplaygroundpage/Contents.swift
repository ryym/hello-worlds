...
if let name = optionalName {
    ...
    greeting = "there is no one.."
}

print(greeting)


// IMPORTANT: Assigning Nil to a normal variable is disallowed!
// var s: String = nil  // Error
...
// Assign fullName if nickName is nil.
//: Switches support any kind of data and a wide variety of comparison operations—they aren’t limited to integers and tests for equality.
//:
let vegetable = "red pepper"

// No breaks and colons. let and where can be used.
switch vegetable {
    case "celery":
...
// The loop variables are constant (let).
